...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.midSectionwidget = QtWidgets.QWidget(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(2)
        sizePolicy.setHeightForWidth(self.midSectionwidget.sizePolicy().hasHeightForWidth())
        self.midSectionwidget.setSizePolicy(sizePolicy)
        self.midSectionwidget.setMaximumSize(QtCore.QSize(16777215, 24))
        self.midSectionwidget.setAutoFillBackground(False)
        self.midSectionwidget.setObjectName("midSectionwidget")
        self.lvl_textEdit = QtWidgets.QTextEdit(self.midSectionwidget)
        self.lvl_textEdit.setGeometry(QtCore.QRect(40, 0, 31, 21))
        ...
        self.level_label = QtWidgets.QLabel(self.midSectionwidget)
        self.level_label.setGeometry(QtCore.QRect(0, 0, 41, 21))
        self.level_label.setObjectName("level_label")
        self.entry_label = QtWidgets.QLabel(self.midSectionwidget)
        self.entry_label.setGeometry(QtCore.QRect(90, 0, 41, 21))
        self.entry_label.setObjectName("entry_label")
        self.entry_textEdit = QtWidgets.QTextEdit(self.midSectionwidget)
        self.entry_textEdit.setGeometry(QtCore.QRect(130, 0, 121, 21))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(2)
        ...
        self.dateTimeEdit = QtWidgets.QDateTimeEdit(self.midSectionwidget)
        self.dateTimeEdit.setGeometry(QtCore.QRect(310, 0, 141, 21))
        ...
        self.time_label = QtWidgets.QLabel(self.midSectionwidget)
